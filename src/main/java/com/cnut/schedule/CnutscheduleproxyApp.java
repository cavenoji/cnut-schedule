...
import com.cnut.schedule.config.DefaultProfileUtil;
...
public class CnutscheduleproxyApp {

    private static final Logger log = LoggerFactory.getLogger(CnutscheduleproxyApp.class);

    /**
     * Initializes CnutscheduleproxyApp.
     * <p>
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = Micronaut.build(args)
            .mainClass(CnutscheduleproxyApp.class)
