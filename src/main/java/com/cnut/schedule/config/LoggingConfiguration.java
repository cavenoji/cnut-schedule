...
import com.cnut.schedule.util.ApplicationProperties;
...
public class LoggingConfiguration {
    ...
    private void addLogstashTcpSocketAppender(LoggerContext context) {
        ...
        logstashAppender.addDestinations(new InetSocketAddress(this.applicationProperties.getLogging().getLogstash().getHost(), this.applicationProperties
            .getLogging().getLogstash().getPort()));
        ...
        context.getLoggerList().forEach((logger) -> {
            for (Iterator<Appender<ILoggingEvent>> it = logger.iteratorForAppenders(); it.hasNext();) {
                ...
                if (!appender.getName().equals(ASYNC_LOGSTASH_APPENDER_NAME)
                        && !(appender.getName().equals(CONSOLE_APPENDER_NAME) && this.applicationProperties
                    .getLogging().isUseJsonFormat())) {
